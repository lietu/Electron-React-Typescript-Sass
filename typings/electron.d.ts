...
declare module "electron" {
    ...
    module Dialog {
         ...
         */
        export function showOpenDialog(browserWindow?: BrowserWindow,
                                       options?: OpenDialogOptions,
                                       callback?: (fileNames: string[]) => void): void;
         ...
         */
        export function showMessageBox(browserWindow?: BrowserWindow,
                                       options?: ShowMessageBoxOptions,
                                       callback?: (response: any) => void): number;
        export function showMessageBox(options: ShowMessageBoxOptions,
                                       callback?: (response: any) => void): number;
    ...
    interface Clipboard {
         ...
         * @returns The contents of the clipboard as a NativeImage.
         */
        readImage: typeof Clipboard.readImage;
        /**
         * Writes the image into the clipboard.
         */
    ...
    export var crashReporter: CrashReporter;
    export var screen: Screen;
    export var shell: Shell;
    export var remote: Remote;
    export var ipcRenderer: IpcRenderer;
    export var webFrame: WebFrame;
    export var app: App;
    export var autoUpdater: AutoUpdater;
    export var contentTracing: ContentTracing;
